...
# from: <https://gist.github.com/allysonsilva/85fff14a22bbdf55485be947566cc09e>
...
[![IMAGE ALT TEXT HERE](https://upload.wikimedia.org/wikipedia/commons/thumb/e/ef/YouTube_logo_2015.svg/1200px-YouTube_logo_2015.svg.png)](https://www.youtube.com/watch?v=9ZFwSC9AAI8)
"""

with tempfile.NamedTemporaryFile(delete=False, suffix=".md", mode="w", encoding="utf-8") as tmp2:
    tmp2.write(md_text2)
    tmp_path2 = tmp2.name

html_output = md2html.convert(tmp_path2, False, "")
print(html_output)
os.remove(tmp_path2)
